    ...
    <div class="page-wrapper">
            ...
            <div class="container-fluid">
                <div class="main-header__inner">
                    ...
                    <div class="main-header__right">
                            ...
                            <ul class="main-menu__list">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="#">Upload completed Application form</a></li>
                                    </ul>
                                </li>
                                <li>
                        ...
                        <a href="#" class="easilon-btn main-header__btn">
        ...
        "dots": true
                ...
                <div class="item">
                    <div class="main-slider-one__item">
                        <div class="main-slider-one__bg"
                            style="background-image: url(assets/images/backgrounds/main-slider-bg-1-1.jpg);">
                                        ...
                                        <div class="main-slider-one__button-group">
                                            <div class="main-slider-one__button-group__inner">
                                                <div class="main-slider-one__button main-slider-one__button--1">
                                                    <a href="#" class="main-slider-one__btn-1 easilon-btn">
                ...
                <div class="item">
                    <div class="main-slider-one__item">
                        <div class="main-slider-one__bg"
                            style="background-image: url(assets/images/backgrounds/main-slider-bg-1-2.jpg);">
                        </div><!-- /.main-slider-one__bg -->
                        <div class="main-slider-one__container container">
                            <div class="row gutter-y-60 align-items-center">
                                <div class="col-lg-7">
                ...
                <div class="item">
                    <div class="main-slider-one__item">
                        <div class="main-slider-one__bg"
                            style="background-image: url(assets/images/backgrounds/main-slider-bg-1-3.jpg);">
                        </div><!-- /.main-slider-one__bg -->
                        <div class="main-slider-one__container container">
                            <div class="row gutter-y-60 align-items-center">
                                <div class="col-lg-7">
                            ...
                            <div class="company-transparency-one__call wow fadeInUp" data-wow-duration="1500ms">
                                ...
                                <div class="company-transparency-one__call__content">
                                    ...
                                    <a href="tel:+163-2654-3654"
                                        class="company-transparency-one__call__number">+163-2654-3654</a>
                        ...
                        "dots": true
                                ...
                                <div class="testimonials-one__item">
                                    <div class="testimonial-card">
                                        ...
                                        <p class="testimonial-card__quote">I recently worked with <span>easilon</span>
                                            for my home renovation project, and I couldn't be happier with the results.
                                            From the moment I walked into their showroom, I was impressed by the
                                            extensive selection</p><!-- /.testimonial-card__quote -->
                                ...
                                <div class="testimonials-one__item">
                                    <div class="testimonial-card">
                                        ...
                                        <p class="testimonial-card__quote">Reach out not the long pole in my tent, but
                                            pull in ten extra bodies to help roll the tortoise, yet face time pipeline,
                                            for blue sky. creativity requires you to murder your children Cross sabers
                                            rehydrate</p><!-- /.testimonial-card__quote -->
                                        <div class="testimonial-card__identity">
                                ...
                                <div class="testimonials-one__item">
                                    <div class="testimonial-card">
                                        ...
                                        <p class="testimonial-card__quote"> This is our north star design at the end of
                                            the day, for digital literacy. Good optics prethink. Green technology and
                                            climate change products need full resourcing and support from a
                                            cross-functional</p><!-- /.testimonial-card__quote -->
                                        <div class="testimonial-card__identity">
