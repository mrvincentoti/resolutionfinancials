        ...
        <div class="container-fluid py-5 pt-lg-0">
            <div class="row gx-0">
                <div class="col-lg-3 wow zoomIn" data-wow-delay="0.1s">
                    <div class="facts-card shadow d-flex align-items-center justify-content-center p-4"
                        style="height: 150px;">
                ...
                <div class="col-lg-3 wow zoomIn" data-wow-delay="0.3s">
                    <div class="bg-light shadow d-flex align-items-center justify-content-center p-4"
                        ...
                        <div class="ps-4">
                            <h5 class="text-primary mb-0">Preparation</h5>
                            <h1 class="mb-0" data-toggle="counter-up">{{ $prep_projects }}</h1>
                        </div>
                    </div>
                </div>
            </div>
