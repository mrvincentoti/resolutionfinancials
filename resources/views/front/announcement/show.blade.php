                    ...
                    <div class="section-title section-title-sm position-relative pb-3 mb-4">
                        ...
                        <div class="card p-3 m-1">
                            <div class="title">
                                ...
                                <button class="my-4 bg-primary text-white p-2"><a class="my-4 bg-primary text-white p-2" href="{{ asset('storage/' . $announcement->document) }}" target="_blank">View Document</a></button>
