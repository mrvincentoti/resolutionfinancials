                ...
                <form method="POST" action="{{ route('admin.banner.update', $banner->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="grid gap-6 mb-6 md:grid-cols-1">
                        <div class="mb-1">
                            ...
                            <input type="text" id="title" value="{{ $banner->title }}" name="title" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Title of the post" required>
                        </div>
                        <div class="mb-1">
                            <label for="slug" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Slug</label>
                            <input type="text" id="slug" value="{{ $banner->slug }}" name="slug"
                        ...
                        <div class="mb-1">
                            ...
                            <input type="text" id="url" value="{{ $banner->url }}" name="url"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        ...
                        <div class="mb-2">
                            ...
                            <textarea id="summernote1"
                                ...
                                id="short_description" name="short_description" required="">{{ $banner->short_description }}</textarea>
                        </div>
                        <div class="mb-2">
                            <label class="block text-sm text-gray-600" for="message">Long Description</label>
                            <textarea id="summernote2"
                                class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                id="long_description" name="long_description" required="">{{ $banner->long_description }}</textarea>
                        </div>
                        <div class="mb-2">
