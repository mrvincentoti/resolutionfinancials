    ...
    <div class="w-full h-screen overflow-x-hidden border-t flex flex-col">
        <main class="w-full flex-grow p-6">
            ...
            <div class="w-full mt-12">
                ...
                <div class="mb-1">
                    <label for="title" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Question</label>
...
{{--                </div>--}}
                ...
                <div class="mb-2">
                    <label class="block text-sm text-gray-600" for="message">Answer</label>
