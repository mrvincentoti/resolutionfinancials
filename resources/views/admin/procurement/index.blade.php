<x-admin-layout>
    ...
    <div class="w-full h-screen overflow-x-hidden border-t flex flex-col">
        <main class="w-full flex-grow p-6">
            <h1 class="w-full text-3xl text-black pb-6">Procurement Document</h1>

            <div class="w-full mt-12">
                <p class="text-xl pb-3 flex items-center">
                    <i class="fas fa-list mr-3"></i> Procurement Document Records
                </p>
                        ...
                        <tbody>
                            @foreach ($procurements as $procurement)
                                <tr class="hover:bg-grey-lighter">
                                    <td class="py-4 px-6 border-b border-grey-light">{{ $procurement->id }}</td>
                                    <td class="py-4 px-6 border-b border-grey-light">{{ $procurement->document_name }}</td>
