<x-admin-layout>
    <div class="w-full h-screen overflow-x-hidden border-t flex flex-col">
        <main class="w-full flex-grow p-6">
            <h1 class="w-full text-3xl text-black pb-6">Edit Procurement Document</h1>

            <div class="w-full mt-12">
                <p class="text-xl pb-3 flex items-center">
                    <i class="fas fa-list mr-3"></i> Procurement Document Details
                </p>
                <form method="POST" action="{{ route('admin.procurement.update', $procurement->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="grid gap-6 mb-6 md:grid-cols-1">
                        <div class="mb-1">
                            ...
                            <input type="text" id="title" value="{{ $procurement->document_name }}" name="document_name"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="Title of the procurement document" required>
                        </div>
                        ...
                        <div class="mb-1">
                            ...
                            <div>
                                <img src="{{ asset('storage/' . $procurement->image) }}" alt="{{ $procurement->document_name }}" class="w-32 h-32 object-cover">
                            </div>
                        </div>
                    </div>
