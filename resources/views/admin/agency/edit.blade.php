<x-admin-layout>
    <div class="w-full h-screen overflow-x-hidden border-t flex flex-col">
        <main class="w-full flex-grow p-6">
            <h1 class="w-full text-3xl text-black pb-6">Edit Supporting Agency Document</h1>

            <div class="w-full mt-12">
                <p class="text-xl pb-3 flex items-center">
                    <i class="fas fa-list mr-3"></i> Supporting Agency Document Details
                </p>
                <form method="POST" action="{{ route('admin.agency.update', $agency->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="grid gap-6 mb-6 md:grid-cols-1">
                        ...
                        <div class="mb-1">
                            ...
                            <div>
                                <img src="{{ asset('storage/' . $agency->image) }}" alt="{{ $agency->title }}" class="w-32 h-32 object-cover">
                            </div>
                        </div>
                    </div>
